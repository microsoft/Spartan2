...
impl<Scalar: PrimeField> Sha256Circuit<Scalar> {
...
fn main() {
  ...
  for circuit in circuits {
    ...
    let summary_msg = format!(
      "SUMMARY circuit size={}, msg={}B, setup={} ms, prep_prove={} ms, prove={} ms, verify={} ms",
      circuit.preimage.len().ilog2(),
      msg_len,
      setup_ms,
      prep_ms,
      prove_ms,
