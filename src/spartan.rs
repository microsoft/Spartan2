//! This module implements the Spartan2 protocol, which is a high-speed zkSNARK without trusted setup.
//! The current implementation is a non-preprocessing version of Spartan that is generic over the polynomial commitment scheme (PCS)
use crate::{
  CommitmentKey,
  bellpepper::{
...
mod tests {
  ...
  fn test_snark() {
    ...
    type S2 = crate::spartan::R1CSSNARK<E2>;
